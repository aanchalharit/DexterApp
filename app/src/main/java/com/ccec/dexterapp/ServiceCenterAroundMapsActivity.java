...
public class ServiceCenterAroundMapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private Marker serviceCenterMarker;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isNetwork()) {
            Toast.makeText(ServiceCenterAroundMapsActivity.this, "Please connect to internet", Toast.LENGTH_LONG).show();
            ServiceCenterAroundMapsActivity.this.finish();
        }
                ...
                try {
                    Intent intent =
                            new PlaceAutocomplete.IntentBuilder(PlaceAutocomplete.MODE_FULLSCREEN)
                                    .build(ServiceCenterAroundMapsActivity.this);
...
//                enterLoc.setText(place.getName());
    ...
    public void onMapReady(final GoogleMap googleMap) {
        ...
        if (!gps_enabled) {
            AlertDialog.Builder dialog = new AlertDialog.Builder(ServiceCenterAroundMapsActivity.this);
            ...
            Toast.makeText(ServiceCenterAroundMapsActivity.this, "Getting location..", Toast.LENGTH_SHORT).show();
        }

        mLocationManager = (LocationManager) getSystemService(LOCATION_SERVICE);

        if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            Toast.makeText(ServiceCenterAroundMapsActivity.this, "Make sure location is on.", Toast.LENGTH_LONG).show();
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                source = "normal";
                if (ActivityCompat.checkSelfPermission(ServiceCenterAroundMapsActivity.this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ServiceCenterAroundMapsActivity.this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    return;
                }
                location = mLocationManager
                        .getLastKnownLocation(LocationManager.NETWORK_PROVIDER);
