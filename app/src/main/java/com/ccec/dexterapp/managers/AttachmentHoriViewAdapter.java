...
public class AttachmentHoriViewAdapter extends RecyclerView.Adapter<AttachmentHoriViewAdapter.ViewHolder> {
    private ArrayList<String> countries;
    private Context ctx;
    private String AudioSavePathInDevice;

    public AttachmentHoriViewAdapter(ArrayList<String> countries, Context ctx) {
        this.countries = countries;
        this.ctx = ctx;
    }

    @Override
    public AttachmentHoriViewAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.custom_attachment_row, viewGroup, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final AttachmentHoriViewAdapter.ViewHolder viewHolder, final int i) {
